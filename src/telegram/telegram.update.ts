        ...
        keyboard: buildKeyboard(
          ...
          [
            ...
            [
              {
                text: '🔄 Làm mới',
                callback_data: buildRefreshCallback(TELEGRAM_CALLBACKS.database),
              },
            ],
          ],
        ),
    ...
    if (navigationCallback === TELEGRAM_CALLBACKS.monitoring) {
      ...
      await this.menuRenderer.renderScreen(context, {
        text: [
          ...
          `⚠️ Degraded: <b>${monitoringSnapshot.degradedCount}</b>`,
        ...
        keyboard: buildKeyboard(
          ...
          [
            ...
            [
              {
                text: '🔄 Làm mới',
                callback_data: buildRefreshCallback(TELEGRAM_CALLBACKS.server),
              },
            ],
          ],
        ),
    ...
    if (navigationCallback === TELEGRAM_CALLBACKS.settings) {
      ...
      await this.menuRenderer.renderScreen(context, {
        text: [
          ...
          `⚠️ Dangerous actions: <b>${settingsSnapshot.dangerousActionsEnabled ? 'Bật' : 'Tắt'}</b>`,
          `⏱️ Confirmation TTL: <b>${settingsSnapshot.confirmationTtlSeconds}s</b>`,
        ...
        keyboard: buildKeyboard(
          ...
          [
            ...
            [
              {
                text: '🔄 Làm mới',
                callback_data: buildRefreshCallback(TELEGRAM_CALLBACKS.audit),
              },
            ],
          ],
        ),
